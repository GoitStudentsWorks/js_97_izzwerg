import{o as h}from"./assets/qoute-7d1581a6.js";import{i as T}from"./assets/vendor-8cce9181.js";function f(){let e=JSON.parse(localStorage.getItem("favorites"))||[];const u=e.map(t=>`<li class="fav-ex-item">
    ...
    `,l=window.innerWidth;let i;l<768?i=8:i=e.length;const m=document.querySelector(".no-fav-ex-inner"),d=document.querySelector(".fav-ex-list"),p=document.querySelector(".fav-pag-btn-set");if(e.length===0?m&&(d.innerHTML="",m.innerHTML=o):d&&(m.innerHTML="",d.innerHTML=u,h()),i<e.length&&p){const t=document.createDocumentFragment(),c=Math.ceil(e.length/i);for(let n=1;n<=c;n++){const s=document.createElement("button");s.classList.add("fav-pagination-btn"),s.textContent=n,s.addEventListener("click",()=>{const v=(n-1)*i,y=v+i,w=e.slice(v,y).map(a=>`<li class="fav-ex-item">
              <div class="fav-ex-item-header">
                  <div class="fav-workout-box">
                      <p class="fav-workout-text">workout</p>
                  </div>
